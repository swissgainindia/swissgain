                ...
                <>
                  ...
                  <Select value={rankFilter} onValueChange={setRankFilter}>
                    ...
                    <SelectContent>
                      ...
                      <SelectItem value="6">Ambassador (6)</SelectItem>
                      <SelectItem value="7">Director (7)</SelectItem>
                      <SelectItem value="8">Chairman (8)</SelectItem>
                      <SelectItem value="9">Crown (9)</SelectItem>
                      <SelectItem value="10">Legend (10)</SelectItem>
                    </SelectContent>
                  </Select>
                </>
              )}
